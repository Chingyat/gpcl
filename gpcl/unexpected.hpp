...
template <typename E> class unexpected {
  template <typename T> friend class unexpected;
...
public:
  ...
  template <typename U, typename... Args,
      std::enable_if_t<
          ...
          int> = 0>
  GPCL_DECL_INLINE constexpr explicit unexpected(
  ...
  template <typename Err,
      ...
      std::enable_if_t<
          detail::is_constructible_v<E, Err> &&
              ...
              !detail::is_convertible_v<const unexpected<Err>, E>,
          int> = 0>
  GPCL_DECL_INLINE constexpr unexpected(const unexpected<Err> &e)
      : val_(e.val_) {}
  ...
  GPCL_DECL_INLINE void swap(unexpected &other) noexcept(
