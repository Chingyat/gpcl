...
namespace gpcl { namespace detail {
    ...
    void win_lock_file::lock() {
      while (!try_lock()) {
        HANDLE hd = FindFirstChangeNotificationA(filename_.c_str(),
                                                 FALSE,
